...
/**
 * @title ArrayAddress Library
 *
 * Helper functions for working with address[] arrays.
 */
library ArrayAddress {
   ...
   */
  function deleteRow(
    address[] storage self, uint256 index, uint256 pointer
   ...
   */
  function addRow(
    address[] storage self, address value, uint256 pointer
  ) public returns (uint256) {
